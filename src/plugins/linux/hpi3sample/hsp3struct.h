...
//		Callback options
//
#define HSPEVENT_ENABLE_COMMAND 1	// When executing single-step
#define HSPEVENT_ENABLE_HSPIRQ 2	// When an interrupt occurs inside HSP
#define HSPEVENT_ENABLE_GETKEY 4	// When checking key input
#define HSPEVENT_ENABLE_FILE 8		// When doing file I/O
#define HSPEVENT_ENABLE_MEDIA 16	// When doing media I/O
#define HSPEVENT_ENABLE_PICLOAD 32	// When executing picload command
